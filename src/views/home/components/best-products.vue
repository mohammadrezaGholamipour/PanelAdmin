...
const state = reactive({
  data: [
    {
      imageProduct: "src/assets/image/best-products/product-sound.png",
      name: "گیاه شناسی",
      category: "طب سنتی",
      type: "دیجیتال",
    ...
    {
      imageProduct: "src/assets/image/best-products/paid.png",
      name: "آموزش حسابداری",
      category: "فناوری",
      type: "دیجیتال",
    ...
    {
      imageProduct: "src/assets/image/best-products/category.png",
      name: "عادت های اتمی",
      category: "کتاب",
      type: "کالا",
    ...
    {
      imageProduct: "src/assets/image/best-products/bg-login.png",
      name: "تلویزیون",
      category: "فناوری",
      type: "کالا",
    ...
    {
      imageProduct: "src/assets/image/best-products/image.png",
      name: "کامپیوتر",
      category: "فناوری",
      type: "کالا",
